...
const routes = [
...

  {
    path: '/data',
    name: 'dataList',
    meta: { title: '数据管理', icon: 'HomeFilled' }, // 修正 title
    type: 'submenu',
    component: Layout,
    children: [
      {
  ...
  },
  {
    ...
    name: 'userAll',
    type: 'submenu',
    meta: { title: '用户管理', icon: 'HomeFilled' }, // 修正 title
    component: Layout,
    children: [
      {
        path: 'list', // 移除开头的斜杠，使用相对路径
        name: 'userList',
        meta: { title: '用户列表', icon: 'HomeFilled' },
      ...
      },
      {
        ...
        name: 'permission',
        meta: { title: '权限配置', icon: 'HomeFilled' },
        component: () => import('@/views/dataList/list/index.vue'),
      },
    ],
  },
  {
    ...
    name: 'systemList',
    type: 'submenu',
    meta: { title: '系统设置', icon: 'HomeFilled' }, // 修正 title
    component: Layout,
    children: [
      {
        path: 'settings', // 移除开头的斜杠，使用相对路径
        name: 'settings',
        meta: { title: '基本设置', icon: 'HomeFilled' },
        component: () => import('@/views/dataList/list/index.vue'),
      },
      {
        path: 'logs', // 移除开头的斜杠，使用相对路径
        name: 'logs',
        meta: { title: '操作日志', icon: 'HomeFilled' },
        component: () => import('@/views/dataList/list/index.vue'),
      },
      {
        path: 'backup', // 移除开头的斜杠，使用相对路径
        name: 'backup',
        meta: { title: '数据备份', icon: 'HomeFilled' },
        component: () => import('@/views/dataList/list/index.vue'),
      },
    ],
  },
